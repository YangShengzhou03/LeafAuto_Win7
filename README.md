...
LeafAuto_Win7 是一个基于 PyQt5 的桌面应用程序，旨在提供自动化任务处理和助手功能。项目包含多个模块，支持多种功能，如自动化信息处理、AI 助手、活动管理等。
...
### 7. `LeafAuto_Win7_version_info.txt`
...
- **pyperclip**: 1.9.0
- **PyQt5-plugins**: 6.4.2.2.3
- **PyQt5-tools**: 6.4.2.3.3
- **python-dotenv**: 1.0.1
- **pywin32**: 308
