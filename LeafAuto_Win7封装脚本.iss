...
[Setup]
; 设置为 none 来禁用自动语言检测，并使用 DefaultLangName 指定默认语言
...
VersionInfoVersion=4.3.9.1
DefaultDirName={autopf}\{#MyAppName}
DisableProgramGroupPage=yes
LicenseFile=D:\Code\python\LeafAuto_Win7\license.txt
...
SetupIconFile=D:\Code\python\LeafAuto_Win7\resources\img\setup.ico
Compression=lzma2/max
SolidCompression=yes
WizardStyle=modern
AppCopyright=© 2025 LeafAuto by YangShengzhou.版权所有
UninstallDisplayIcon={app}\resources\img\icon.ico
