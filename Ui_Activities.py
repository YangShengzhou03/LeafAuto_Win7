...
"}")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("resources/img/activity/兑换激活码.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("resources/img/窗口控制/窗口控制-关闭.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        self.pushButton_year = QtWidgets.QPushButton(self.frame_select_version)
...
"}")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("resources/img/activity/year.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_VIP = QtWidgets.QPushButton(self.frame_select_version)
...
"}")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("resources/img/activity/VIP.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_AiVIP = QtWidgets.QPushButton(self.frame_select_version)
...
"}")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("resources/img/activity/AiVIP.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_Base = QtWidgets.QPushButton(self.frame_select_version)
...
"}")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("resources/img/activity/Base.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("resources/img/activity/QQ_Act.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
